export default function Notes() {
    ...
    const headerClasses = "font-lato xl:text-2xl lg:text-xl font-bold text-nowrap \
        text-shadow-[0_0_16px_rgb(255_255_255_/_0.25)]"
    const textClasses = "absolute bottom-0 top-0 flex items-center xl:text-5xl lg:text-4xl font-lato font-bold"
